...
<div class="max-w-2xl mx-auto" id="feed-posts-container">
    ...
    <?php if (empty($posts) && empty($error)): ?>
        <div class="text-center text-gray-500 dark:text-gray-400 mt-12 py-10">
            ...
            <?php else: ?>
                 <p><a href="<?php echo BASE_URL; ?>/auth/google"
        ...
        <div class="space-y-6">
            <?php foreach ($posts as $post): ?>
                 <?php
                    ...
                    $isAuthor = ($currentUserId !== null && $currentUserId === $post['author_id']);
                 ?>
                    ...
                    <div class="post-content-area px-4 pb-4">
                        ...
                        <form class="post-edit-form hidden mt-2" data-post-id="<?php echo $post['post_id']; ?>">
                             <textarea name="content" rows="5"
                                       class="w-full p-2 border border-input bg-background rounded-md focus:ring-1 focus:ring-ring focus:outline-none resize-y placeholder:text-muted-foreground text-sm"
                             ...
                             <div class="flex justify-end items-center space-x-2 mt-2">
                                 ...
                                 <button type="submit"
                                         class="edit-save-button inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-8 px-3">
                                     Save Changes
                                 </button>
                             </div>
                        </form>
